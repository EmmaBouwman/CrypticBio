...
def parse_args():
    parser = argparse.ArgumentParser(description="Train BirdSat Transformer Classifier")
    ...
    parser.add_argument("--save_name", type=str, default="best_bird_sat_model.pth", help="Filename for best checkpoint")
