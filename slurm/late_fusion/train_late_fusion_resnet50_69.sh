#!/bin/bash
<<<<<<<< HEAD:slurm/late_fusion/train_late_fusion_resnet50_69.sh
...
========
#SBATCH --job-name=late_fusion_model_69_50
#SBATCH --output=logs/job_%x_%j.out
#SBATCH --mail-user="s2800020@vuw.leidenuniv.nl"
#SBATCH --mail-type="END"
#SBATCH --mem=128G
#SBATCH --time=3-00:00:00
>>>>>>>> ee834e6 (created new late fusion slurm files with different random seeds):slurm/late_fusion/train_late_fusion_69_50.sh
...
python scripts/train_test.py \
    --batch_size 32 \
========
echo "Job: $SLURM_JOB_ID | Model: fusion50 | Random seed: 69"
python scripts/train_test.py \
    --batch_size 64 \
>>>>>>>> ee834e6 (created new late fusion slurm files with different random seeds):slurm/late_fusion/train_late_fusion_69_50.sh
    --num_workers 8 \
...
========
    --model_name "resnet50" \
    --save_name "best_late_fusion_69_50.pth" \
    --model_type 5 \
    --random_seed 69
>>>>>>>> ee834e6 (created new late fusion slurm files with different random seeds):slurm/late_fusion/train_late_fusion_69_50.sh
